...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'ar_SA': {
          ...
          'personalInfoShare':
              'ستتم مشاركة معلوماتك مع المستشفى في حال طلب إسعاف',
          ...
          'aboutUsTitle1': 'سياسة الخصوصية',
          //  'aboutUsTitle3': 'الاسئلة المتكررة',
          'aboutUsTitle2': 'موقعنا',
          'changeGoogleAccount': 'تغيير حساب جوجل',
          'cancelRequestConfirm':
              'هل أنت متأكد أنك تريد إلغاء طلب الإسعاف الخاص بك؟',
          'pendingRequest': 'تم إرسال طلب الإسعاف',
          'assignedRequest': 'تم تعيين طلب الإسعاف',
          'acceptedRequest': 'تم قبول طلب الإسعاف',
          'requestCanceled':
              'تم رفض طلب الإسعاف الخاص بك من قبل المستشفى أو انقضت مهلته',
          'addresses': 'العناوين',
          'sponsors': 'رعاتنا',
          ...
          'reportRequest': 'الإبلاغ عن مشكلة في طلب الإسعاف الخاص بك',
        ...
        'en_US': {
          ...
          'pendingRequest': 'Ambulance request was sent',
          'requestDetails': 'Request details',
          'assignedRequest': 'Ambulance request was assigned',
          'acceptedRequest': 'Ambulance request was accepted',
          'enterMedicalHistory':
          ...
          'waitingForAssign': 'Waiting for your ambulance car to be assigned',
          ...
          'aboutUsTitle1': 'Privacy policy',
          // 'aboutUsTitle3': 'FAQ',
          'aboutUsTitle2': 'Our website',
